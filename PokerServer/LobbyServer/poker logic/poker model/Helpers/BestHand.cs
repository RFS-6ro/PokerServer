namespace TexasHoldem.Logic.Helpers
{
    ...
    {
        public BestHand(HandRankType rankType, ICollection<SafeInt> cards)
        {
            if (cards.Count != 5)
            {
        ...
        public ICollection<SafeInt> Cards { get; }
        ...
        private static int CompareTwoHandsWithHighCard(
            ICollection<SafeInt> firstHand,
            ICollection<SafeInt> secondHand)
        {
